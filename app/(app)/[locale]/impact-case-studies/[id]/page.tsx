...
export async function generateStaticParams(props: {
	params: Pick<ImpactCaseStudyPageProps["params"], "locale">;
}): Promise<Awaited<Array<Pick<ImpactCaseStudyPageProps["params"], "id">>>> {
	const { params } = props;

	const { locale } = params;

	const ids = await createCollectionResource("impact-case-studies", locale).list();
...
export async function generateMetadata(
	...
	const impactCaseStudyItem = await createCollectionResource("impact-case-studies", locale).read(
		id,
	);
