...
import { Filters } from "@/app/(app)/_components/search/filters";
import { Hits } from "@/app/(app)/_components/search/hits";
import { SearchInput } from "@/app/(app)/_components/search/search-input";
import { Stats } from "@/app/(app)/_components/search/stats";
...
export function Search(props: SearchProps): ReactNode {
	...
	return (
		...
		>
			<Configure
				filters={content === "resources" ? resourcesFilters() : filters()}
