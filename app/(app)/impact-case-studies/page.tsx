...
export async function generateMetadata(): Promise<Metadata> {
	const page = await createSingletonResource("impact-case-studies-overview", defaultLocale).read();
...
export default async function ImpactCaseStudiesPage(): Promise<ReactNode> {
	...
	const entries = await createCollectionResource("impact-case-studies", defaultLocale).all();
