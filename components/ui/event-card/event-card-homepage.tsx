...
export function EventCardHomepage(props: Readonly<EventCardProps>): ReactNode {
	...
	return (
		<NavLink
			className="shadow-event-card max-w-full cursor-pointer w-116 bg-event-card-bg group flex-col 2xl:w-116 2xl:min-w-116 focus-visible:outline-4 focus-visible:outline-accent"
			href={href}
		>
