	...
	variants: {
		variant: {
			...
			"button-secondary-black": cn(
				"cursor-pointer p-1.5 box-border *:flex *:justify-center *:items-center *:size-full *:gap-2 [&>svg]:fill-white",
			...
			"button-tertiary": cn(
				"cursor-pointer py-1.5 px-5.5 box-border justify-center flex items-center gap-2 border-2 border-primary [&>span]:w-fit",
				"bg-primary outline-2 outline-white text-white text-regular w-62.75 [&>svg]:fill-white",
				"hover:bg-white hover:border-white hover:outline-primary hover:text-primary hover:[&>svg]:fill-primary",
				"focus:bg-primary focus:outline-primary focus:border-white focus:text-white focus:[&>svg]:fill-white",
			),
			unstyled: "",
		},
	},
