...
export function ListDescription(props: Readonly<ListDescriptionProps>): ReactNode {
	...
	return (
		<div
			className={cn(
				"gap-4 xl:columns-2 xl:gap-x-16 3xl:gap-x-23.5 *:break-inside-avoid *:first:mt-0! [&>h2:first-child]:text-h2!",
				"[&>h2:first-child]:font-light! [&>:is(h1,h2):first-child]:pb-12 [&>h3]:break-after-avoid",
