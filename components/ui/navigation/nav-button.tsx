...
export function NavButton(props: Readonly<NavButtonProps>): ReactNode {
	...
	return (
		<ElementType
			{...rest}
			className={cn(
				"group cursor-pointer bg-transparent p-2 flex gap-1 text-text-link-bg items-center uppercase [&>svg]:size-5 [&>svg]:fill-text-link-bg",
				...
				"aria-expanded:border-b-3 aria-expanded:pb-1.25 aria-expanded:border-b-primary aria-expanded:bg-white",
