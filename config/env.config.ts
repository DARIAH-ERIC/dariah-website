...
const result = createEnv({
	schemas: {
		...
		public(environment) {
			const schema = v.object({
				...
				NEXT_PUBLIC_TYPESENSE_SEARCH_COLLECTION_NAME: v.pipe(v.string(), v.nonEmpty()),
	...
	environment: {
		...
		NEXT_PUBLIC_TYPESENSE_SEARCH_COLLECTION_NAME:
			process.env.NEXT_PUBLIC_TYPESENSE_SEARCH_COLLECTION_NAME,
