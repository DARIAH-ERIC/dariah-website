...
const config: Config = {
	...
	redirects() {
		const redirects: Awaited<ReturnType<NonNullable<Config["redirects"]>>> = [
			...
			{ source: "/about/history-of-dariah", destination: "/about/dariah-in-a-nutshell", permanent: true },
			{ source: "/about/join-dariah", destination: "/get-involved/join-dariah", permanent: true },
			{ source: "/about/mission-vision", destination: "/about/dariah-in-a-nutshell", permanent: true },
			{ source: "/activities/dariah-theme", destination: "/get-involved/funding-calls", permanent: true },
			...
			{ source: "/activities/training-and-education", destination: "/about/strategy", permanent: true },
