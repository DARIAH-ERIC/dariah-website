...
const config: Config = {
	...
	redirects() {
		const redirects: Awaited<ReturnType<NonNullable<Config["redirects"]>>> = [
			{ source: "/about/dariah-in-nutshell", destination: "/about/dariah-in-a-nutshell", permanent: true },
			...
			{ source: "/activities/impact-case-studies/:path*", destination: "/about/impact-case-studies/:path*", permanent: true },
			{ source: "/activities/working-groups-list", destination: "/network/working-groups", permanent: true },
			{ source: "/activities/working-groups/:path*", destination: "/network/working-groups/:path*", permanent: true },
			...
			{ source: "/tools-services/tools-and-services", destination: "/resources/dariah-resource-catalogue", permanent: true },
			{ source: String.raw`/:year(\d{4})/:month(\d{2})/:date(\d{2})/:path*`, destination: "/news/:path*", permanent: true },
			// { source: "/about/history-of-dariah", destination: "", permanent: true },
			// { source: "/about/glossary", destination: "", permanent: true },
			// { source: "/about/mission-vision", destination: "", permanent: true },
			// { source: "/about/publications", destination: "", permanent: true },
			// { source: "/activities/dariah-theme", destination: "", permanent: true },
			// { source: "/activities/training-and-education", destination: "", permanent: true },
			// { source: "/activities/open-science", destination: "", permanent: true },
			// { source: "/activities/open-science/dariah-open", destination: "", permanent: true },
			// { source: "/activities/open-science/data-re-use", destination: "", permanent: true },
			// { source: "/activities/open-science/openmethods", destination: "", permanent: true },
